...
const questions = [
    {type: 'input', message: 'Enter the title of your project:', name: 'projTitle', validate: (value) => {if(value) {return true} else { return 'Please enter a title for your project'}}},
    ...
    {type: 'input', message: 'Enter any contributors, to include tutorial websites:', name: 'contributors'},
    {type: 'input', message: 'Enter any test instructions:', name: 'testInst', },
